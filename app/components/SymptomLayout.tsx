...
import { SymptomArticle, UrgencyLevel } from "../data/symptom-articles";
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="sticky top-28 space-y-6">
              <div className="bg-gray-50 rounded-[2rem] p-7">
                ...
                <ul className="space-y-3 text-sm font-bold text-slate-gray">
                  ...
                  <li><a href="#emergency" className="hover:text-brand-start transition-colors flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-red-300 flex-shrink-0" />Emergency Signs</a></li>
                  <li><a href="#causes" className="hover:text-brand-start transition-colors flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-gray-300 flex-shrink-0" />Possible Causes</a></li>
                  <li><a href="#home-care" className="hover:text-brand-start transition-colors flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-gray-300 flex-shrink-0" />Home Care & Vet</a></li>
                  <li><a href="#prevention" className="hover:text-brand-start transition-colors flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-gray-300 flex-shrink-0" />Prevention</a></li>
          ...
          <main className="lg:col-span-9">
            ...
            {/* Emergency Warnings */}
            <div id="emergency" className="bg-red-50 border-2 border-red-200 rounded-[2rem] p-8 mb-14">
                  ...
                  return (
                    <div key={i} className={`${sev.bg} ${sev.border} border rounded-[2rem] p-7`}>
                      <div className="flex items-start justify-between gap-4 mb-3">
                        ...
                        <span className={`flex-shrink-0 text-[10px] font-black uppercase tracking-widest ${sev.text} border ${sev.border} px-3 py-1 rounded-full`}>{cause.severity}</span>
                      </div>
            ...
            {/* Home care + when to see vet */}
            <div id="home-care" className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              <div className="bg-gray-50 rounded-[2rem] p-7 border border-gray-100">
                <h2 className="text-xl font-black text-ebony uppercase tracking-tighter mb-6 border-l-8 border-brand-start pl-4">Home Care Tips</h2>
              ...
              <div className="bg-gray-50 rounded-[2rem] p-7 border border-gray-100">
                <h2 className="text-xl font-black text-ebony uppercase tracking-tighter mb-6 border-l-8 border-brand-start pl-4">When to See a Vet</h2>
                <ul className="space-y-4">
            ...
            {/* Prevention */}
            <div className="mb-16" id="prevention">
