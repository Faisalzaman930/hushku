          ...
          <div className="mx-auto max-w-4xl px-6 lg:px-8">
            <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm p-10 flex flex-col sm:flex-row gap-6 items-start sm:items-center justify-between">
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h2 className="text-xl font-black text-ebony uppercase tracking-tight mb-2">How Do Care Reminders Work?</h2>
                  <p className="text-sm text-slate-gray leading-relaxed max-w-lg">Step-by-step guide to creating reminders, setting repeat schedules, and getting push notifications.</p>
                </div>
              </div>
