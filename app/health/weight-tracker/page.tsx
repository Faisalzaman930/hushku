          ...
          <div className="mx-auto max-w-4xl px-6 lg:px-8">
            <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm p-10 flex flex-col sm:flex-row gap-6 items-start sm:items-center justify-between">
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h2 className="text-xl font-black text-ebony uppercase tracking-tight mb-2">How to Use the Weight Tracker</h2>
                  <p className="text-sm text-slate-gray leading-relaxed max-w-lg">Learn how to log weight entries, read the trend chart, and share your pet's history with your vet.</p>
                </div>
              </div>
