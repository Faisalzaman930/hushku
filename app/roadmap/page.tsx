...
const phases = [
  {
    ...
    desc: "The full foundation is built and live — matching, adoption, fostering, shelters, lost & found, health & care suite, social feed, and push notifications.",
    items: [
      { label: "Playdate Matching", desc: "Swipe-based proximity matching to find compatible playdate partners, filtered by breed, size, temperament, and purpose (walk, playdate, mating, adoption)." },
      ...
      { label: "Shelters Directory", desc: "Browse verified shelters and rescues near you. Shelters have their own login and dashboard to list pets and manage admission requests." },
      { label: "Lost & Found Alerts", desc: "Hyper-local push alerts for missing pets — report lost or found animals with photo, description, and GPS radius notifications." },
      { label: "Daily Care Tracker", desc: "One-tap logging for fed, watered, and poop — with a daily progress bar and full care history." },
      { label: "Care Reminders", desc: "Recurring push reminders for walks, feeding, medication, vaccinations, vet appointments, and custom care tasks." },
      { label: "Weight Tracker", desc: "Log your pet's weight over time and see the trend. Includes target weight ranges and shareable history for vet visits." },
      { label: "Health Records", desc: "Upload and store vaccination certificates, vet visit summaries, medication logs, and lab reports — all in one digital health wallet." },
      { label: "Flea & Tick Tracker", desc: "Log flea and tick treatment dates, track the product used, and set reminders for the next dose." },
      { label: "Heat Cycle Tracker", desc: "Track heat cycles for female pets — log cycle dates, view history, and get estimated next-cycle predictions." },
      { label: "Social Feed", desc: "A neighbourhood pet feed for sharing moments, following local owners, and discovering pets in your area." },
  ...
  },
  {
    ...
    items: [
      { label: "Vet Discovery & Booking", desc: "Find nearby veterinary clinics, view profiles and specialties, and book appointments directly in the app." },
